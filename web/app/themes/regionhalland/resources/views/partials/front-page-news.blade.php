@php($myNews = get_region_halland_news_archive_taxonomi_category_items(4))
@foreach($myNews as $news)
    <article class="rh-search-elements">
        ...
        <p class="rh-search-elements-description">{{ html_entity_decode(wp_trim_words($news->post_content, 60, '...')) }}</p> 
    </article>
@endforeach
